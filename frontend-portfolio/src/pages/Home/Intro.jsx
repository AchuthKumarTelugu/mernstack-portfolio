...
function Intro() {
  return (
    <div className=' bg-primary flex flex-col items-start justify-center space-y-8 py-10'>
      ...
      <p className='text-white w-2/3'>Enthusiastic and results-oriented MERN stack developer.Eager to leverage strong knowledge of MongoDB, Express, React, and Node.js to contribute to a collaborative and innovative team environment. </p>
